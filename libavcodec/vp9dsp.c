...
static void avg##_8tap_##type##_##sz##dir##_c(uint8_t *dst, \
                                              const uint8_t *src, \
                                              ptrdiff_t dst_stride, \
                                              ptrdiff_t src_stride, \
                                              int h, int mx, int my) \
...
static void avg##_bilin_##sz##dir##_c(uint8_t *dst, const uint8_t *src, \
                                      ...
                                      int h, int mx, int my) \
{ \
    avg##_bilin_1d_##dir##_c(dst, src, dst_stride, src_stride, sz, h, dir_m); \
}
...
static void avg##_bilin_##sz##hv_c(uint8_t *dst, const uint8_t *src, \
                                   ...
                                   int h, int mx, int my) \
{ \
    avg##_bilin_2d_hv_c(dst, src, dst_stride, src_stride, sz, h, mx, my); \
}
