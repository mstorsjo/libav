...
void ff_##avg##_8tap_1d_##dir##_##sz##_##opt(uint8_t *dst, const uint8_t *src, \
                                             ptrdiff_t dst_stride, \
                                             ptrdiff_t src_stride, \
...
ff_##avg##_8tap_1d_##dir##_##sz##_##opt(uint8_t *dst, const uint8_t *src, \
                                        ptrdiff_t dst_stride, \
                                        ptrdiff_t src_stride, \
                                        int h, const int8_t (*filter)[16]) \
{ \
    ff_##avg##_8tap_1d_##dir##_##hsz##_##opt(dst, src, dst_stride, \
                                             src_stride, h, filter); \
    ff_##avg##_8tap_1d_##dir##_##hsz##_##opt(dst + hsz, src + hsz, \
                                             dst_stride, \
                                             src_stride, h, filter); \
}
...
static void op##_8tap_##fname##_##sz##hv_ssse3(uint8_t *dst, \
                                               const uint8_t *src, \
                                               ptrdiff_t dst_stride, \
                                               ptrdiff_t src_stride, \
                                               int h, int mx, int my) \
{ \
    ...
    ff_##op##_8tap_1d_v_##sz##_ssse3(dst, temp + 3 * 64, dst_stride, 64, \
...
static void op##_8tap_##fname##_##sz##dir##_ssse3(uint8_t *dst, \
                                                  const uint8_t *src, \
                                                  ptrdiff_t dst_stride, \
                                                  ptrdiff_t src_stride, \
                                                  int h, int mx, int my) \
{ \
    ff_##op##_8tap_1d_##dir##_##sz##_ssse3(dst, src, dst_stride, src_stride, \
