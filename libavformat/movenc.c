...
static int mov_flush_fragment(AVFormatContext *s, int force)
{
    ...
    avio_write_marker(s->pb, avio_tell(s->pb),
                      ...
                      has_video ? starts_with_key : mov->tracks[first_track].cluster[0].flags & MOV_SYNC_SAMPLE);
...
AVOutputFormat ff_mov_muxer = {
    ...
    .flags             = AVFMT_GLOBALHEADER | AVFMT_ALLOW_FLUSH | AVFMT_TS_NEGATIVE | AVFMT_OUTPUT_POS,
...
AVOutputFormat ff_f4v_muxer = {
    ...
    .write_packet      = mov_write_packet,
    .write_trailer     = mov_write_trailer,
    .flags             = AVFMT_GLOBALHEADER | AVFMT_ALLOW_FLUSH | AVFMT_OUTPUT_POS,
